...
function(e) {
    ...
    function(t) {
        ...
        t.WebExternalInterface = i,
        e.registerClass(i, "egret.web.WebExternalInterface", ["egret.ExternalInterface"]),
        e.ExternalInterface = i
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(i) {
            ...
            s.load = function(t) {
                function i() {
                    o(),
                    l.indexOf("firefox") >= 0 && (a.pause(), a.muted = !1),
                    s.loaded = !0,
                    s.dispatchEventWith(e.Event.COMPLETE)
                }
                function r() {
                    o(),
                    s.dispatchEventWith(e.IOErrorEvent.IO_ERROR)
                }
                function o() {
                ...
                l.indexOf("firefox") >= 0 && (a.autoplay = !0, a.muted = !0),
                a.load(),
                this.originAudio = a,
                n.$recycle(this.url, a)
            },
            s.play = function(i, r) {
                i = +i || 0,
                r = +r || 0;
                var o = n.$pop(this.url);
                null == o && (o = this.originAudio.cloneNode()),
                o.autoplay = !0;
        ...
        t.HtmlSound = i,
        e.registerClass(i, "egret.web.HtmlSound", ["egret.Sound"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(i) {
            function n(t) {
                ...
                t.addEventListener("ended", this.onPlayEnd),
                this.audio = t
            }
            __extends(n, i);
            var r = __define,
            ...
            s.stop = function() {
                if (this.audio) {
                    ...
                    var i = this.audio;
                    i.pause(),
                    i.removeEventListener("ended", this.onPlayEnd),
                    this.audio = null,
                    t.HtmlSound.$recycle(this.$url, i)
                }
            },
            r(s, "volume",
            function() {
        ...
        t.HtmlSoundChannel = i,
        e.registerClass(i, "egret.web.HtmlSoundChannel", ["egret.SoundChannel", "egret.IEventDispatcher"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(i) {
            ...
            return s.load = function(i) {
                var n = this;
                this.url = i,
                QZAppExternal.preloadSound(function(t) {
        ...
        t.QQSound = i,
        e.registerClass(i, "egret.web.QQSound", ["egret.Sound"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(t) {
            ...
            return o.$play = function() {
                ...
                var i = 0;
                i = t.$loops > 0 ? t.$loops - 1 : -1,
                this.$type == e.Sound.EFFECT ? QZAppExternal.playLocalSound(function(e) {},
                {
                    bid: -1,
                    url: t.$url,
                    loop: i
        ...
        t.QQSoundChannel = i,
        e.registerClass(i, "egret.web.QQSoundChannel", ["egret.SoundChannel", "egret.IEventDispatcher"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function() {
            ...
            return e.decodeAudios = function() {
                if (! (e.decodeArr.length <= 0 || e.isDecoding)) {
                    ...
                    e.ctx.decodeAudioData(t.buffer,
                    function(i) {
                        t.self.audioBuffer = i,
                        t.success && t.success(),
                        e.isDecoding = !1,
                        e.decodeAudios()
                    },
        ...
        t.WebAudioDecode = i,
        e.registerClass(i, "egret.web.WebAudioDecode");
        var n = function(n) {
            function r() {
                n.call(this),
                this.loaded = !1
            ...
            a.play = function(i, n) {
                ...
                return r.$url = this.url,
                r.$loops = n,
                r.$audioBuffer = this.audioBuffer,
                r.$startTime = i,
                r.$play(),
                e.sys.$pushSoundChannel(r),
                r
        ...
        t.WebAudioSound = n,
        e.registerClass(n, "egret.web.WebAudioSound", ["egret.Sound"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(i) {
            function n() {
                ...
                this.context = t.WebAudioDecode.ctx,
                this.isStopped = !1,
                this._currentTime = 0,
                this._volume = 1,
                this.onPlayEnd = function() {
            ...
            return s.$play = function() {
                ...
                this.bufferSource = n,
                n.buffer = this.$audioBuffer,
                n.connect(i),
                i.connect(t.destination),
                n.onended = this.onPlayEnd,
                this._startTime = Date.now(),
        ...
        t.WebAudioSoundChannel = i,
        e.registerClass(i, "egret.web.WebAudioSoundChannel", ["egret.SoundChannel", "egret.IEventDispatcher"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(t) {
            function i(i) {
                ...
                this.$renderRegion = new e.sys.Region,
                this.src = i,
                this.once(e.Event.ADDED_TO_STAGE, this.loadPoster, this),
                i && this.load()
            }
            __extends(i, t);
            var n = __define,
            ...
            return o.load = function(e) {
                ...
                if (e = e || this.src, this.src = e, !this.video || this.video.src != e) {
                    ...
                    i.addEventListener("canplay", this.onVideoLoaded),
            ...
            o.play = function(t, i) {
                var n = this;
                if (void 0 === i && (i = !1), 0 == this.loaded) return this.load(this.src),
                ...
                this.isPlayed = !0;
                var r = this.video;
                void 0 != t && (r.currentTime = +t || 0),
                r.loop = !!i,
                e.Capabilities.isMobile ? r.style.zIndex = "-88888": r.style.zIndex = "9999",
                r.style.position = "absolute",
                r.style.top = "0px",
                r.style.left = "0px",
                r.height = this.heightSet,
                r.width = this.widthSet,
                "Windows PC" != e.Capabilities.os && "Mac OS" != e.Capabilities.os && setTimeout(function() {
                    r.width = 0
                },
                1e3),
            ...
            o.checkFullScreen = function(t) {
                var i = this.video;
                t ? (null == i.parentElement && (i.removeAttribute("webkit-playsinline"), document.body.appendChild(i)), e.stopTick(this.markDirty, this), this.goFullscreen()) : (null != i.parentElement && i.parentElement.removeChild(i), i.setAttribute("webkit-playsinline", "true"), this.setFullScreenMonitor(!1), e.startTick(this.markDirty, this)),
                i.play()
            },
            o.goFullscreen = function() {
                var t, i = this.video;
                return t = e.web.getPrefixStyleName("requestFullscreen", i),
                i[t] || (t = e.web.getPrefixStyleName("requestFullScreen", i), i[t]) ? (i.removeAttribute("webkit-playsinline"), i[t](), this.setFullScreenMonitor(!0), !0) : !0
            },
        ...
        t.WebVideo = i,
        e.registerClass(i, "egret.web.WebVideo", ["egret.Video"]),
        e.Video = i
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        ...
        t.WebHttpRequest = i,
        e.registerClass(i, "egret.web.WebHttpRequest", ["egret.HttpRequest"]),
        e.HttpRequest = i
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
        ...
        n = function(n) {
            ...
            a.load = function(i) {
                if (t.Html5Capatibility._canUseBlob && 0 != i.indexOf("wxLocalResource:") && 0 != i.indexOf("data:") && 0 != i.indexOf("http:") && 0 != i.indexOf("https:")) {
                    var n = this.request;
                    n || (n = this.request = new e.web.WebHttpRequest, n.addEventListener(e.Event.COMPLETE, this.onBlobLoaded, this), n.addEventListener(e.IOErrorEvent.IO_ERROR, this.onBlobError, this), n.responseType = "blob"),
                    n.open(i),
                    n.send()
            ...
            a.loadImage = function(e) {
                ...
                this.data = null,
                this.currentImage = t,
                this._hasCrossOriginSet ? this._crossOrigin && (t.crossOrigin = this._crossOrigin) : r.crossOrigin && (t.crossOrigin = r.crossOrigin),
            ...
            a.getImage = function(t) {
                ...
                return n.onerror = null,
                n.onload = null,
                this.currentImage !== n ? null: (this.currentImage = null, n)
            },
            r.crossOrigin = null,
            r
        } (e.EventDispatcher);
        t.WebImageLoader = n,
        e.registerClass(n, "egret.web.WebImageLoader", ["egret.ImageLoader"]),
        e.ImageLoader = n
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
    ...
    function(t) {
        var i = function(i) {
            ...
            o._initElement = function() {
                ...
                this.inputDiv.style.left = t * o + "px",
                this.inputDiv.style.top = i * s + "px",
                this.$textfield.multiline && this.$textfield.height > this.$textfield.size ? (this.inputDiv.style.top = i * s + "px", this.inputElement.style.top = -this.$textfield.lineSpacing / 2 * s + "px") : (this.inputDiv.style.top = i * s + "px", this.inputElement.style.top = "0px"),
                this._gscaleX = o * n,
                this._gscaleY = s * r
            },
            o.$show = function() {
                this.htmlInput.isCurrentStageText(this) ? this.inputElement.onblur = null: (this.inputElement = this.htmlInput.getInputElement(this), this.inputDiv = this.htmlInput._inputDIV),
            ...
            o.$hide = function() {
                this._isNeesHide = !0,
                this.htmlInput && e.web.Html5Capatibility._System_OS == e.web.SystemOSType.IOS && this.htmlInput.disconnectStageText(this)
            },
            o.$getText = function() {
            ...
            o.setAreaHeight = function() {
                ...
                if (t.multiline) {
                    ...
                    if (t.height <= t.size || t.height < i) this.setElementStyle("height", t.size * this._gscaleY + "px"),
            ...
            o.$resetStageText = function() {
                if (this.inputElement) {
                    ...
                    if (this.setElementStyle("width", i * this._gscaleX + "px"), this.setElementStyle("verticalAlign", t.verticalAlign), t.multiline) this.setAreaHeight();
                        ...
                        var n = t.size / 2 * this._gscaleY;
                        this.setElementStyle("padding", "0px 0px " + n + "px 0px")
                    } else {
                        this.setElementStyle("height", t.size * this._gscaleY + "px");
                        var r = (t.height - t.size) * this._gscaleY,
                        o = e.TextFieldUtils.$getValign(t),
                        s = r * o,
                        n = r - s;
                        n < t.size / 2 * this._gscaleY && (n = t.size / 2 * this._gscaleY),
                        this.setElementStyle("padding", s + "px 0px " + n + "px 0px")
                    }
                    ...
                    this.inputDiv.style.width = i * this._gscaleX + "px"
                }
            },
            n
        } (e.EventDispatcher);
        t.HTML5StageText = i,
        e.registerClass(i, "egret.web.HTML5StageText", ["egret.StageText"]),
        e.StageText = i
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
    ...
    function(t) {
        var i = function() {
            ...
            n.initInputElement = function(e) {
                var t, i = this;
                e ? (t = document.createElement("textarea"), t.style.resize = "none", i._multiElement = t, t.id = "egretTextarea") : (t = document.createElement("input"), i._simpleElement = t, t.id = "egretInput"),
                t.type = "text",
                i._inputDIV.appendChild(t),
            ...
            n.disconnectStageText = function(e) { (null == this._stageText || this._stageText == e) && (this.clearInputElement(), this._inputElement && this._inputElement.blur())
            },
            ...
            n.getInputElement = function(e) {
                ...
                var i;
                return i = t._simpleElement == t._inputElement ? t._multiElement: t._simpleElement,
        ...
        t.HTMLInput = i,
        e.registerClass(i, "egret.web.HTMLInput")
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(e) {
        function t(e) {
            ...
            s = r[t],
            a = o[t];
            return s && a && (delete r[t], delete o[t]),
            i
        }
        function i(e, t, i, s) {
            e._initStageDelegateDiv(i, s),
            n[t.$hashCode] = e,
            r[t.$hashCode] = s,
            o[t.$hashCode] = i
        }
    ...
    function(t) {
        ...
        r = function() {
            function t() {
                ...
                e.sys.hitTestRenderContext = this.create().renderContext;
            ...
            return o.create = function(t) {
                ...
                if (!r) {
                    ...
                    if (o.width = o.height = 1, n && !this.testCanvasValid(o)) return e.warn("failed to create canvas!"),
                    null;
        ...
        t.CanvasFactory = r,
        e.registerClass(r, "egret.web.CanvasFactory", ["egret.sys.SurfaceFactory"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(t) {
            function i(i, n) {
                ...
                this.rotation = 0,
                this.canvas = n,
                this.touch = new e.sys.TouchHandler(i),
                this.addListeners()
            }
            __extends(i, t);
            var n = (__define, i),
            ...
            r.addTouchListener = function() {
                ...
                function(t) {
                    for (var i = t.changedTouches.length,
                    n = 0; i > n; n++) e.onTouchBegin(t.changedTouches[n]);
                    e.prevent(t)
                },
                !1),
                ...
                function(t) {
                    for (var i = t.changedTouches.length,
                    n = 0; i > n; n++) e.onTouchMove(t.changedTouches[n]);
                    e.prevent(t)
                },
                !1),
                ...
                function(t) {
                    for (var i = t.changedTouches.length,
                    n = 0; i > n; n++) e.onTouchEnd(t.changedTouches[n]);
                    e.prevent(t)
                },
                !1),
            ...
            r.getLocation = function(t) {
                ...
                l = t.pageY - o,
                h = l;
                return 90 == this.rotation ? (a = l, h = n.width - s) : -90 == this.rotation && (a = n.height - l, h = s),
                a /= this.scaleX,
                h /= this.scaleY,
                e.$TempPoint.setTo(Math.round(a), Math.round(h))
            },
        ...
        t.WebTouchHandler = i,
        e.registerClass(i, "egret.web.WebTouchHandler")
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function(t) {
            ...
            return r.registerListener = function() {
                ...
                if ((u || l) && (h = !1), h) {
                    ...
                    d.execWebFn = d.execWebFn || {},
                    d.execWebFn.postX5GamePlayerMessage = function(e) {
                        var t = e.type;
        ...
        t.WebHideHandler = i,
        e.registerClass(i, "egret.web.WebHideHandler")
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        ...
        t.AudioType = r,
        e.registerClass(r, "egret.web.AudioType");
        var o = function() {
            function e() {}
            var t = (__define, e);
            t.prototype;
        ...
        t.SystemOSType = o,
        e.registerClass(o, "egret.web.SystemOSType");
        var s = function(t) {
            function i() {
                t.call(this)
            }
            ...
            return i._init = function() {
                ...
                if (i.ua = t, e.Capabilities.$isMobile = -1 != t.indexOf("mobile") || -1 != t.indexOf("android"), i._canUseBlob = !1, i._audioType = r.HTML5_AUDIO, i._AudioClass = e.web.HtmlSound, i._audioMustLoad = !0, t.indexOf("windows phone") >= 0) i._System_OS = o.WPHONE,
                i._audioMustLoad = !1,
                e.Capabilities.$os = "Windows Phone";
                ...
                h || i._audioType != r.WEB_AUDIO || (i._audioType = r.HTML5_AUDIO, i._AudioClass = e.web.HtmlSound),
            ...
            i.checkHtml5Support = function() {
                ...
                i = t.split("-");
                i.length > 1 && (i[1] = i[1].toUpperCase()),
                e.Capabilities.$language = i.join("-")
            },
            i._canUseBlob = !1,
            i._audioType = 0,
            i._audioMustLoad = !1,
        ...
        t.Html5Capatibility = s,
        e.registerClass(s, "egret.web.Html5Capatibility"),
        s._init();
        var a = null;
        t.getPrefixStyleName = i,
        t.getPrefix = n
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
    ...
    function(t) {
        ...
        function n() {
            if (!s) {
                ...
                e.sys.surfaceFactory = n,
                e.sys.screenAdapter || (e.sys.screenAdapter = new e.sys.ScreenAdapter);
...
function(e) {
    ...
    function(t) {
        ...
        e.registerClass(HTMLImageElement, i),
        e.registerClass(HTMLCanvasElement, i),
        e.registerClass(HTMLVideoElement, i)
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        var i = function() {
            ...
            return t.detect = function() {
                ...
                t.$isMobile = -1 != i.indexOf("mobile") || -1 != i.indexOf("android"),
                t.$isMobile ? i.indexOf("windows") < 0 && ( - 1 != i.indexOf("iphone") || -1 != i.indexOf("ipad") || -1 != i.indexOf("ipod")) ? t.$os = "iOS": -1 != i.indexOf("android") && -1 != i.indexOf("linux") ? t.$os = "Android": -1 != i.indexOf("windows") && (t.$os = "Windows Phone") : -1 != i.indexOf("windows nt") ? t.$os = "Windows PC": -1 != i.indexOf("mac os") && (t.$os = "Mac OS");
        ...
        t.WebCapability = i,
        e.registerClass(i, "egret.web.WebCapability"),
        i.detect()
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
    ...
    function(t) {
        var i = function(i) {
            ...
            return o.init = function(i) {
                ...
                r = new e.Stage;
                r.$screen = this,
                r.$scaleMode = n.scaleMode,
                r.$orientation = n.orientation,
                r.$maxTouches = n.maxTouches,
                r.frameRate = n.frameRate,
                r.textureScaleFactor = n.textureScaleFactor;
                ...
                u = new t.HTMLInput;
                l.showPaintRect(n.showPaintRect),
                (n.showFPS || n.showLog) && l.displayFPS(n.showFPS, n.showLog, n.logFilter, n.fpsStyles),
                this.playerOption = n,
                this.container = i,
                this.canvas = s,
                this.stage = r,
                this.player = l,
                this.webTouchHandler = a,
                this.webInput = u,
                this.webHide = h,
                e.web.$cacheTextAdapter(u, r, i, s),
            ...
            o.readOption = function(t) {
                ...
                i.showPaintRect = "true" == t.getAttribute("data-show-paint-rect"),
                i.showFPS = "true" == t.getAttribute("data-show-fps");
                for (var n = t.getAttribute("data-show-fps-style") || "", r = n.split(","), o = {},
                s = 0; s < r.length; s++) {
                    var a = r[s].split(":");
                    o[a[0]] = a[1]
                }
            ...
            o.attachCanvas = function(e, t) {
                ...
                i.overflow = "hidden",
                i.position = "relative",
                i.webkitTransform = "translateZ(0)"
            },
            o.updateScreenSize = function() {
                ...
                if (!t.userTyping) {
                    ...
                    var f = d / h,
                    v = c / u;
                    this.webTouchHandler.updateScaleMode(f, v, p),
        ...
        t.WebPlayer = i,
        e.registerClass(i, "egret.web.WebPlayer", ["egret.sys.Screen"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {}));
var egret; !
function(e) {
    ...
    function(t) {
        function i(t, i) {
            ...
            null == i && (i = e.$TempRectangle, i.x = 0, i.y = 0, i.width = r, i.height = o),
            i.x = Math.min(i.x, r - 1),
            i.y = Math.min(i.y, o - 1),
            i.width = Math.min(i.width, r - i.x),
            i.height = Math.min(i.height, o - i.y);
            var s = i.width,
            a = i.height;
            n.width = s,
            n.height = a,
            ...
            d = l._bitmapWidth,
            c = l._bitmapHeight;
            return n.renderContext.drawImage(l._bitmapData, l._bitmapX + i.x / e.$TextureScaleFactor, l._bitmapY + i.y / e.$TextureScaleFactor, d * i.width / r, c * i.height / o, h, u, i.width, i.height),
            n
        }
        function n(t, n) {
            try {
                var r = i(this, n),
                o = r.toDataURL(t);
                return e.sys.surfaceFactory.release(r),
                o
            } catch(s) {
                e.$error(1033)
            }
        ...
        function o(t, n) {
            ...
            return r = o.renderContext.getImageData(1, 1, 1, 1),
            r.data
        }
        e.Texture.prototype.toDataURL = n,
        e.Texture.prototype.saveToFile = r,
...
function(e) {
    ...
    function(t) {
        ...
        t.XMLNode = r,
        e.registerClass(r, "egret.web.XMLNode");
        var o = function(e) {
        ...
        t.XML = o,
        e.registerClass(o, "egret.web.XML");
        var s = function(e) {
            function t(t, i) {
                e.call(this, 3, i),
                this.text = t
        ...
        t.XMLText = s,
        e.registerClass(s, "egret.web.XMLText");
        var a = new DOMParser;
        e.XML = {
            parse: i
        }
...
function(e) {
    ...
    function(t) {
        ...
        t.WebDeviceOrientation = i,
        e.registerClass(i, "egret.web.WebDeviceOrientation", ["egret.DeviceOrientation"])
    } (t = e.web || (e.web = {}))
} (egret || (egret = {})),
...
function(e) {
    ...
    function(t) {
        ...
        t.WebGeolocation = i,
        e.registerClass(i, "egret.web.WebGeolocation", ["egret.Geolocation"]),
...
function(e) {
    ...
    function(t) {
        var i = function(t) {
            function i() {
                ...
                this.onChange = function(t) {
                    ...
                    n.acceleration = r,
                    n.accelerationIncludingGravity = o,
                    n.rotationRate = s,
                    i.dispatchEvent(n)
                }
            }
        ...
        t.WebMotion = i,
        e.registerClass(i, "egret.web.WebMotion", ["egret.Motion"]),

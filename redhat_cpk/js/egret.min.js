...
function(t) {
    function e(t, e, i) {
        ...
        i && (r = r.concat(i));
        var s = n.__types__;
        if (n.__types__) for (var a = s.length,
        o = 0; a > o; o++) {
...
function(t) {
    ...
    t.HashObject = e,
    t.registerClass(e, "egret.HashObject", ["egret.IHashObject"])
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = [],
    i = function(i) {
        ...
        s.$addListener = function(t, e, i, n, r, s) {
            ...
            o = n ? a[2] : a[1],
            h = o[t];
            h ? 0 !== a[3] && (o[t] = h = h.concat()) : h = o[t] = [],
            this.$insertEventBin(h, t, e, i, n, r, s)
        },
        s.$insertEventBin = function(t, e, i, n, r, s, a) {
            ...
            return - 1 !== o ? t.splice(o, 0, u) : t.push(u),
            !0
        },
        ...
        s.$removeEventBin = function(t, e, i) {
            ...
            r = 0; n > r; r++) {
                var s = t[r];
                if (s.listener == e && s.thisObject == i && s.target == this) return t.splice(r, 1),
                !0
            }
            return ! 1
        },
    ...
    t.EventDispatcher = i,
    t.registerClass(i, "egret.EventDispatcher", ["egret.IEventDispatcher"])
} (egret || (egret = {}));
var egret; !
function(t) {
    function e(t) {
    ...
    var i = function(i) {
        function n() {
            ...
            this.$alpha = 1,
            this.$touchEnabled = n.defaultTouchEnabled,
        ...
        a.invalidatePosition = function() {
            ...
            this.$parent && this.$parent.$propagateFlagsUp(4)
        },
        r(a, "name",
        function() {
        ...
        a.$getMatrix = function() {
            ...
            return this.$hasFlags(8) && (t[6].$updateScaleAndRotation(t[0], t[1], t[2], t[3]), this.$removeFlags(8)),
            t[6]
        },
        ...
        a.$getConcatenatedMatrix = function() {
            ...
            if (this.$hasFlags(16)) {
                ...
                this.$displayList && (this.$displayList.$renderRegion.moved = !0),
                this.$renderRegion && (this.$renderRegion.moved = !0),
                this.$removeFlags(16)
            }
            return e
        },
        a.$getInvertedConcatenatedMatrix = function() {
            var t = this.$DisplayObject;
            return this.$hasFlags(32) && (this.$getConcatenatedMatrix().$invertInto(t[8]), this.$removeFlags(32)),
            t[8]
        },
        r(a, "x",
        function() {
        ...
        a.$setScaleY = function(t) {
            return t = +t || 0,
            t == this.$DisplayObject[1] ? !1 : (this.$DisplayObject[1] = t, this.invalidateMatrix(), !0)
        },
        r(a, "rotation",
        function() {
        ...
        a.$setAnchorOffsetX = function(t) {
            return t = +t || 0,
            t == this.$DisplayObject[12] ? !1 : (this.$DisplayObject[12] = t, this.invalidatePosition(), !0)
        },
        r(a, "anchorOffsetY",
        function() {
        ...
        a.$setAnchorOffsetY = function(t) {
            return t = +t || 0,
            t == this.$DisplayObject[13] ? !1 : (this.$DisplayObject[13] = t, this.invalidatePosition(), !0)
        },
        r(a, "visible",
        function() {
            return this.$visible
        ...
        a.$setVisible = function(t) {
            return t = !!t,
            t == this.$visible ? !1 : (this.$visible = t, this.$invalidateTransform(), !0)
        },
        r(a, "cacheAsBitmap",
        function() {
        ...
        a.$setAlpha = function(t) {
            return t = +t || 0,
            t == this.$alpha ? !1 : (this.$alpha = t, this.$propagateFlagsDown(64), this.$invalidate(), !0)
        },
        ...
        a.getBounds = function(t, e) {
            if (void 0 === e && (e = !0), t = this.$getTransformedBounds(this, t), e) {
                var i = this.$DisplayObject; (0 != i[12] || 0 != i[13]) && (t.x -= i[12], t.y -= i[13])
            }
            return t
        },
        ...
        a.$getOriginalBounds = function() {
            ...
            return this.$hasFlags(4) && (t.copyFrom(this.$getContentBounds()), this.$measureChildBounds(t), this.$removeFlags(4), this.$displayList && (this.$displayList.$renderRegion.moved = !0)),
            t
        },
        a.$measureChildBounds = function(t) {},
        a.$getContentBounds = function() {
            var t = this.$DisplayObject[10];
            return this.$hasFlags(2) && (this.$measureContentBounds(t), this.$renderRegion && (this.$renderRegion.moved = !0), this.$removeFlags(2)),
            t
        },
        ...
        a.$invalidateTransform = function() {
            if (!this.$hasFlags(512)) {
                this.$setFlags(512);
                var t = this.$displayList; (t || this.$renderRegion) && this.$parentDisplayList && this.$parentDisplayList.markDirty(t || this)
            }
        },
        a.$update = function(t) {
            ...
            s.copyFrom(e);
            var a = n.root;
            return a !== this.$stage && this.$getConcatenatedMatrixAt(a, s),
            n.$ratioMatrix.$preMultiplyInto(s, s),
            r.updateRegion(i, s),
            !0
        },
        ...
        a.dispatchEvent = function(t) {
            ...
            this.$dispatchPropagationEvent(t, e, n),
        ...
        n.defaultTouchEnabled = !1,
        n.$enterFrameCallBackList = [],
        n.$renderCallBackList = [],
        n
    } (t.EventDispatcher);
    t.DisplayObject = i,
    t.registerClass(i, "egret.DisplayObject", ["egret.sys.Renderable"])
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
        function i(n) {
            ...
            this.$fillMode = "scale",
            this._pixelHitTest = !1,
            this.$renderRegion = new t.sys.Region,
            this.$Bitmap = {
                0 : null,
                1 : null,
                2 : 0,
        ...
        s.$hitTest = function(t, i) {
            ...
            return n && this._pixelHitTest && (n = this.hitTestPixel(t, i)),
            n
        },
        s.hitTestPixel = function(e, i) {
            ...
            if (h) {
                ...
                n = t.sys.hitTestRenderContext,
                n.surface.width = n.surface.height = 3,
                n.translate(1 - a, 1 - o),
                this.$render(n);
                try {
        ...
        i.$drawImage = function(e, n, r, s, a, o, h, l, c, u, d, f, g, p, $) {
            if (n) if (e.imageSmoothingEnabled = $, g) i.$drawScale9GridImage(e, n, g, r, s, a, o, h, l, c, u, d, f);
                ...
                var T, _ = n; (_.width != a || _.height != o || 1 != t.$TextureScaleFactor) && (T = t.sys.surfaceFactory.create(!0), T.width = c, T.height = u, T.renderContext.drawImage(_, r, s, a, o, h, l, a * t.$TextureScaleFactor, o * t.$TextureScaleFactor), _ = T);
                var b = e.createPattern(_, "repeat");
                e.beginPath(),
                e.rect(0, 0, d, f),
                e.fillStyle = b,
                e.fill(),
                T && t.sys.surfaceFactory.release(T)
            }
        },
        i.$drawScale9GridImage = function(e, i, n, r, s, a, o, h, l, c, u, d, f) {
            ...
            P = B + f - O,
            k = f - v - O;
            x > 0 && (y > 0 && e.drawImage(i, _, E, y, x, M, B, $, v), m > 0 && e.drawImage(i, b, E, m, x, D, B, A, v), F > 0 && e.drawImage(i, C, E, F, x, I, B, L, v)),
            T > 0 && (y > 0 && e.drawImage(i, _, R, y, T, M, N, $, k), m > 0 && e.drawImage(i, b, R, m, T, D, N, A, k), F > 0 && e.drawImage(i, C, R, F, T, I, N, L, k)),
            w > 0 && (y > 0 && e.drawImage(i, _, S, y, w, M, P, $, O), m > 0 && e.drawImage(i, b, S, m, w, D, P, A, O), F > 0 && e.drawImage(i, C, S, F, w, I, P, L, O))
        },
        i.defaultSmoothing = !0,
        i
    } (t.DisplayObject);
    t.Bitmap = e,
    t.registerClass(e, "egret.Bitmap")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.BitmapFillMode = e,
    t.registerClass(e, "egret.BitmapFillMode")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.BlendMode = e,
    t.registerClass(e, "egret.BlendMode")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e; !
    function(t) {
        ...
        for (var n = ["normal", "add", "erase"], r = {},
        s = n.length, a = 0; s > a; a++) {
            var o = n[a];
            r[o] = a
        }
...
function(t) {
    var e = function(e) {
        ...
        return s.$propagateFlagsDown = function(t) {
            if (!this.$hasFlags(t)) {
                ...
                i = 0; i < e.length; i++) e[i].$propagateFlagsDown(t)
            }
        },
        n(s, "numChildren",
        function() {
        ...
        s.$doAddChild = function(e, n, r) {
            void 0 === r && (r = !0);
            var s = e.$parent;
            if (s == this) return this.doSetChildIndex(e, n),
            e;
            s && s.removeChild(e),
        ...
        s.getChildByName = function(t) {
            ...
            n = i.length,
            r = 0; n > r; r++) if (e = i[r], e.name == t) return e;
            return null
        },
        ...
        s.$doRemoveChild = function(e, n) {
            ...
            if (this.$childRemoved(s, e), n && s.dispatchEventWith(t.Event.REMOVED, !0), this.$stage) {
                ...
                for (var a = i.$EVENT_REMOVE_FROM_STAGE_LIST; a.length > 0;) {
                    var o = a.shift();
                    n && o.dispatchEventWith(t.Event.REMOVED_FROM_STAGE),
                    o.$stage = null
                }
            }
            var h = this.$displayList || this.$parentDisplayList;
            this.assignParentDisplayList(s, h, null),
            s.$propagateFlagsDown(624),
            s.$setParent(null);
            var l = r.indexOf(s);
            return r.splice(l, 1),
            this.$propagateFlagsUp(4),
        ...
        s.doSwapChildrenAt = function(t, e) {
            ...
            r = n[t],
            s = n[e];
            this.$childRemoved(r, t),
            this.$childRemoved(s, e),
            n[t] = s,
            n[e] = r,
            this.$childAdded(s, t),
            this.$childAdded(r, e),
            r.$invalidateTransform(),
            s.$invalidateTransform(),
            this.$propagateFlagsUp(4)
        },
        ...
        s.$cacheAsBitmapChanged = function() {
            ...
            for (var t = this.$displayList || this.$parentDisplayList,
            i = this.$children,
            n = i.length - 1; n >= 0; n--) this.assignParentDisplayList(i[n], t, t)
        },
        ...
        s.$setAlpha = function(t) {
            return t = +t || 0,
            t == this.$alpha ? !1 : (this.$alpha = t, this.$propagateFlagsDown(64), this.$invalidate(), this.$invalidateAllChildren(), !0)
        },
    ...
    t.registerClass(e, "egret.DisplayObjectContainer")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.GradientType = e,
    t.registerClass(e, "egret.GradientType")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
        function i() {
            ...
            this._maxX = 0,
            this._maxY = 0,
            this.$renderContext = new t.GraphicsRenderContext
        }
        __extends(i, e);
        var n = __define,
        r = i,
        s = r.prototype;
        return n(s, "graphicsRenderContext",
        function() {
        ...
        s.$hitTest = function(e, i) {
            ...
            o.surface.width = o.surface.height = 3,
            o.translate(1 - s, 1 - a),
            this.$renderContext.$render(o, !0);
        ...
        s.beginFill = function(t, e) {
            void 0 === e && (e = 1),
            this.fillStyle = this._parseColor(t, e),
        ...
        s._setStyle = function(t) {
            this.$renderContext.fillStyle = t,
        ...
        s.getGradient = function(e, i, n, r, s) {
            ...
            for (var c = i.length,
            u = 0; c > u; u++) l.addColorStop(r[u] / 255, this._parseColor(i[u], n[u]));
            return l.matrix = h,
            t.sys.surfaceFactory.release(a),
            l
        },
        s.drawRect = function(t, e, i, n) {
            this.$renderContext.beginPath(),
            this.$renderContext.rect(t, e, i, n),
            this.$renderContext.closePath()
        },
        s.drawCircle = function(t, e, i) {
            this.$renderContext.beginPath(),
            this.$renderContext.arc(t, e, i, 0, 2 * Math.PI),
            this.$renderContext.closePath()
        },
        s.drawRoundRect = function(t, e, i, n, r, s) {
            ...
            p = f - u;
            this.$renderContext.beginPath(),
            this.$renderContext.moveTo(g, p),
            this.$renderContext.quadraticCurveTo(d, f, d - c, f),
            this.$renderContext.lineTo(a + c, f),
            this.$renderContext.quadraticCurveTo(a, f, a, f - u),
            this.$renderContext.lineTo(a, o + u),
            this.$renderContext.quadraticCurveTo(a, o, a + c, o),
            this.$renderContext.lineTo(d - c, o),
            this.$renderContext.quadraticCurveTo(d, o, d, o + u),
            this.$renderContext.lineTo(g, p),
            this.$renderContext.closePath()
        },
        s.drawEllipse = function(t, e, i, n) {
            ...
            h = n / a;
            a /= 2,
            this.$renderContext.scale(o, h),
            this.$renderContext.beginPath(),
            this.$renderContext.arc(r / o, s / h, a, 0, 2 * Math.PI),
            this.$renderContext.closePath(),
            this.$renderContext.scale(1 / o, 1 / h)
        },
        s.lineStyle = function(t, e, i, n, r, s, a, o) {
            ...
            this.strokeStyleColor = this._parseColor(e, i),
            this.moveTo(this.lineX, this.lineY),
            0 >= t && (t = 1),
            this.$renderContext.lineWidth = t,
        ...
        s.lineTo = function(t, e) {
            this.lineX = t,
            this.lineY = e,
            this.$renderContext.lineTo(t, e)
        },
        s.curveTo = function(t, e, i, n) {
            this.lineX = i,
            this.lineY = n,
            this.$renderContext.quadraticCurveTo(t, e, i, n)
        },
        s.drawArc = function(t, e, i, n, r, s) {
            this.lineX = Math.cos(r) + t,
            this.lineY = Math.sin(r) + e,
            this.$renderContext.arc(t, e, i, n, r, s)
        },
        s.cubicCurveTo = function(t, e, i, n, r, s) {
            this.lineX = r,
            this.lineY = s,
            this.$renderContext.bezierCurveTo(t, e, i, n, r, s)
        },
        s.moveTo = function(t, e) {
            this.lineX = t,
            this.lineY = e,
            this.$renderContext.moveTo(t, e)
        },
        s.clear = function() {
            this.lineX = 0,
            this.lineY = 0,
        ...
        s.endFill = function() { (null != this.fillStyle || null != this.strokeStyleColor) && (this._fill(), this.fillStyle = null, this.$renderContext.fillStyle = null, this.$renderContext.strokeStyle = null)
        },
        ...
        s._fill = function() {
            this.fillStyle && this._createEndFillCommand(),
            this.strokeStyleColor && this._createEndLineCommand()
        },
    ...
    t.Graphics = e,
    t.registerClass(e, "egret.Graphics")
} (egret || (egret = {}));
var egret; !
function(t) {
    function e(t) {
    ...
    function r(t) {
        ...
        e[18] = t.arcTo,
        e[17] = t.beginPath,
        e[14] = t.bezierCurveTo,
        e[10] = t.closePath,
        e[9] = t.fill,
        e[13] = t.fillRect,
        e[8] = t.lineTo,
        e[12] = t.moveTo,
        e[7] = t.quadraticCurveTo,
        e[11] = t.rect,
        e[15] = t.stroke,
        e[16] = t.strokeRect,
        e[19] = t.scale,
    ...
    c = function(c) {
        ...
        function(e) {
            "number" == typeof e && (e = t.toColorString(e)),
            this._fillStyle = e,
            this.pushCommand(5, arguments)
        }),
        d(g, "lineWidth",
        function() {
        ...
        function(t) {
            this._lineWidth = t,
            isNaN(t) ? this._maxLineWidth = 0 : this._maxLineWidth = Math.max(this._maxLineWidth, t),
            this.pushCommand(3, arguments)
        }),
        d(g, "lineCap",
        function() {
        ...
        function(e) {
            var i = e;
            "number" == typeof i && (i = t.toColorString(i)),
            this._strokeStyle = i,
            this.pushCommand(4, arguments)
        }),
        d(g, "lineJoin",
        function() {
        ...
        function(t) {
            this._miterLimit = t,
            this.pushCommand(0, arguments)
        }),
        g.scale = function(t, e) {
            this.pushCommand(19, arguments)
        },
        g.arc = function(t, e, i, n, r, s) {
            this.pushCommand(6, arguments),
            0 > i || (s ? this.arcBounds(t, e, i, r, n) : this.arcBounds(t, e, i, n, r))
        },
        g.arcBounds = function(t, i, n, r, o) {
            if (r = e(r), o = e(o), Math.abs(r - o) < .01) return this.extendByPoint(t - n, i - n),
            void this.extendByPoint(t + n, i + n);
            r > o && (o += a);
            for (var h = Math.cos(r) * n, l = Math.cos(o) * n, c = Math.min(h, l), u = Math.max(h, l), d = Math.sin(r) * n, f = Math.sin(o) * n, g = Math.min(d, f), p = Math.max(d, f), $ = r / (.5 * s), v = o / (.5 * s), y = Math.ceil($); v >= y; y++) switch (y % 4) {
            case 0:
                u = n;
                break;
            case 1:
            ...
            u = Math.ceil(u),
            p = Math.ceil(p),
            this.extendByPoint(c + t, g + i),
            this.extendByPoint(u + t, p + i)
        },
        g.quadraticCurveTo = function(t, e, i, n) {
            this.pushCommand(7, arguments),
            this.checkMoveTo(),
            this.extendByPoint(t, e),
            this.extendByPoint(i, n)
        },
        g.bezierCurveTo = function(t, e, i, n, r, s) {
            this.pushCommand(14, arguments),
            this.checkMoveTo(),
            this.extendByPoint(t, e),
            this.extendByPoint(i, n),
            this.extendByPoint(r, s)
        },
        g.lineTo = function(t, e) {
            this.pushCommand(8, arguments),
            this.checkMoveTo(),
            this.extendByPoint(t, e)
        },
        g.fill = function(t) {
            this.pushCommand(9, arguments),
            this.hasFill = !0
        },
        ...
        g.rect = function(t, e, i, n) {
            this.pushCommand(11, arguments),
            this.extendByPoint(t, e),
            this.extendByPoint(t + i, e + n)
        },
        g.moveTo = function(t, e) {
            this.pushCommand(12, arguments),
            this.moveToX = t,
            this.moveToY = e,
            this.hasMoved = !0
        },
        g.fillRect = function(t, e, i, n) {
            this.pushCommand(13, arguments),
            this.extendByPoint(t, e),
            this.extendByPoint(t + i, e + n),
            this.hasFill = !0
        },
        g.stroke = function() {
            this.pushCommand(15, arguments),
            this.hasStroke = !0
        },
        g.strokeRect = function(t, e, i, n) {
            this.pushCommand(16, arguments),
            this.hasStroke = !0,
            this.extendByPoint(t, e),
            this.extendByPoint(t + i, e + n)
        },
        g.beginPath = function() {
            this.pushCommand(17, arguments),
            this.hasMoved = !1,
            this.moveToX = 0 / 0,
            this.moveToY = 0 / 0
        },
        g.arcTo = function(t, r, a, c, u) {
            if (this.pushCommand(18, arguments), !isNaN(this.moveToX)) {
                this.checkMoveTo(),
                n(this.moveToX, this.moveToY, t, r, h),
                n(a, c, t, r, l),
                o.x = h.x + l.x,
                o.y = h.y + l.y,
                n(o.x, o.y, 0, 0, o);
        ...
        g.$measureContentBounds = function(t) {
        ...
        g.$render = function(t, e) {
            ...
            this._strokeStyle && this._maxLineWidth > 0 && (i[15].apply(t, []), i[10].apply(t, [])),
            this._fillStyle && (i[9].apply(t, []), i[10].apply(t, [])),
            t.restore()
        },
        u
    } (t.HashObject);
    t.GraphicsRenderContext = c,
    t.registerClass(c, "egret.GraphicsRenderContext")
} (egret || (egret = {}));
var egret; !
function(t) {
    ...
    var e = function(e) {
        ...
        s.$initData = function(e, n, r, s, a, o, h, l, c, u) {
            ...
            this._bitmapX = e / d,
            this._bitmapY = n / d,
            this._bitmapWidth = r / d,
            this._bitmapHeight = s / d,
            this._offsetX = a,
            this._offsetY = o,
            this._textureWidth = h,
            this._textureHeight = l,
            this._sourceWidth = c,
        ...
        i.$invalidate = function(e) {
            var n;
            if (e instanceof i ? e._bitmapData && (n = e._bitmapData.hashCode) : n = e.hashCode, n && i._displayList[n]) for (var r = i._displayList[n], s = 0; s < r.length; s++) r[s] instanceof t.Bitmap && r[s].$refreshImageData(),
            r[s].$invalidateContentBounds()
        },
        i.$dispose = function(e) {
            var n;
            if (e instanceof i ? e._bitmapData && (n = e._bitmapData.hashCode) : n = e.hashCode, n && i._displayList[n]) {
                for (var r = i._displayList[n], s = 0; s < r.length; s++) r[s] instanceof t.Bitmap && (r[s].$Bitmap[1] = null),
                r[s].$invalidateContentBounds();
    ...
    t.Texture = e,
    t.registerClass(e, "egret.Texture")
} (egret || (egret = {}));
var egret; !
function(t) {
    ...
    n = function(n) {
        ...
        return a.drawToTexture = function(e, i, n) {
            ...
            this.rootDisplayList && (t.sys.DisplayList.release(this.rootDisplayList), this.rootDisplayList = null),
            this.context && t.sys.surfaceFactory.release(this.context.surface);
            ...
            this.rootDisplayList = t.sys.DisplayList.create(o),
            o.$displayList = this.rootDisplayList,
            o.$children.push(e);
            var h = e.$renderRegion;
            h || (e.$renderRegion = t.sys.Region.create());
            var l = e.$parent;
            e.$parent = null,
            this.$saveParentDisplayList(e),
            this.$update(e),
            e.$parent = l,
            h || (t.sys.Region.release(e.$renderRegion), e.$renderRegion = null);
            var c = e.$renderMatrix,
            u = t.Matrix.create();
            c.$invertInto(u),
            i && u.translate( - i.x, -i.y),
            n && u.scale(n, n),
            this.context.clearRect(0, 0, s, a),
            this.context.setTransform(u.a, u.b, u.c, u.d, u.tx, u.ty);
            this.drawDisplayObject(o, this.context, u);
            return t.Matrix.release(u),
            this._setBitmapData(this.context.surface),
            this.$initData(0, 0, s, a, 0, 0, s, a, s, a),
            this.$reset(e),
            this.$displayListMap = {},
            !0
        },
        a.$saveParentDisplayList = function(e) {
            if (this.$displayListMap[e.$hashCode] = e.$displayList, e.$displayList = this.rootDisplayList, e instanceof t.DisplayObjectContainer) for (var i = e.$children,
            n = i.length,
            r = 0; n > r; r++) {
                var s = i[r];
        ...
        a.$update = function(e) {
            if (e.$renderRegion && (e.$renderRegion.moved = !0, e.$update()), e instanceof t.DisplayObjectContainer) for (var i = e.$children,
            n = i.length,
            r = 0; n > r; r++) {
                var s = i[r];
                this.$update(s)
        ...
        a.$reset = function(e) {
            if (e.$displayList = this.$displayListMap[e.$hashCode], e instanceof t.DisplayObjectContainer) for (var i = e.$children,
            n = i.length,
            r = 0; n > r; r++) {
                var s = i[r];
                this.$reset(s)
        ...
        a.drawDisplayObject = function(t, e, i) {
            ...
            l = 0; h > l; l++) {
                var c = o[l]; ! c.$visible || c.$alpha <= 0 || c.$maskedObject || (s += 0 !== c.$blendMode || c.$mask ? this.drawWithClip(c, e, i) : c.$scrollRect || c.$maskRect ? this.drawWithScrollRect(c, e, i) : this.drawDisplayObject(c, e, i))
            }
            return s
        },
        a.drawWithClip = function(n, r, s) {
            ...
            if (u) {
                ...
                l.updateRegion(f, u.$getConcatenatedMatrix())
            }
            var g;
            if (c && (g = t.sys.Region.create(), g.updateRegion(c, d)), g && l ? (g.intersect(l), t.sys.Region.release(l)) : !g && l && (g = l), g) {
                if (g.isEmpty()) return t.sys.Region.release(g),
                a
            } else g = t.sys.Region.create(),
            f = n.$getOriginalBounds(),
            g.updateRegion(f, n.$getConcatenatedMatrix());
            var p = this.createRenderContext(g.width, g.height);
            if (!p) return a += this.drawDisplayObject(n, r, s),
            t.sys.Region.release(g),
            a;
            if (c) {
                var $ = d;
                p.setTransform($.a, $.b, $.c, $.d, $.tx - g.minX, $.ty - g.minY),
                p.beginPath(),
            ...
            if (a += this.drawDisplayObject(n, p, v), t.Matrix.release(v), u) {
                ...
                if (!y) return a += this.drawDisplayObject(n, r, s),
                t.sys.surfaceFactory.release(p.surface),
                t.sys.Region.release(g),
                a;
                y.setTransform(1, 0, 0, 1, -g.minX, -g.minY),
                v = t.Matrix.create().setTo(1, 0, 0, 1, -g.minX, -g.minY);
                var x = this.drawDisplayObject(u, y, v);
                t.Matrix.release(v),
                x > 0 && (a += x, p.globalCompositeOperation = "destination-in", p.setTransform(1, 0, 0, 1, 0, 0), p.globalAlpha = 1, p.drawImage(y.surface, 0, 0)),
                t.sys.surfaceFactory.release(y.surface)
            }
            return a > 0 && (a++, o && (r.globalCompositeOperation = h), s ? (r.translate(g.minX, g.minY), r.drawImage(p.surface, 0, 0), r.setTransform(s.a, s.b, s.c, s.d, s.tx, s.ty)) : (r.setTransform(1, 0, 0, 1, g.minX, g.minY), r.drawImage(p.surface, 0, 0)), o && (r.globalCompositeOperation = i)),
            t.sys.surfaceFactory.release(p.surface),
            t.sys.Region.release(g),
            a
        },
        a.drawWithScrollRect = function(e, i, n) {
            ...
            return s.isEmpty() || o.updateRegion(s, a),
            o.isEmpty() ? (t.sys.Region.release(o), r) : (i.save(), n ? (i.setTransform(n.a, n.b, n.c, n.d, n.tx, n.ty), i.transform(a.a, a.b, a.c, a.d, a.tx, a.ty)) : i.setTransform(a.a, a.b, a.c, a.d, a.tx, a.ty), i.beginPath(), i.rect(0, 0, s.width, s.height), i.clip(), n && i.setTransform(n.a, n.b, n.c, n.d, n.tx, n.ty), r += this.drawDisplayObject(e, i, n), i.restore(), t.sys.Region.release(o), r)
        },
    ...
    t.RenderTexture = n,
    t.registerClass(n, "egret.RenderTexture")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
        ...
        s.$hitTest = function(t, i) {
            var n = e.prototype.$hitTest.call(this, t, i);
            return n == this && (n = this.$graphics.$hitTest(t, i)),
            n
        },
        s.$render = function(t) {
...
function(t) {
    ...
    t.Sprite = e,
    t.registerClass(e, "egret.Sprite")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
        ...
        r.createTexture = function(e, i, n, r, s, a, o, h, l) {
            ...
            void 0 === l && (l = o + s);
            var c = new t.Texture;
            return c._bitmapData = this.texture._bitmapData,
            c.$initData(this._bitmapX + i, this._bitmapY + n, r, s, a, o, h, l, this.texture._sourceWidth, this.texture._sourceHeight),
            this._textureMap[e] = c,
            c
        },
        r.dispose = function() {
    ...
    t.SpriteSheet = e,
    t.registerClass(e, "egret.SpriteSheet")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
        function i() {
            ...
            this.$stageHeight = 0,
            this.implMap = {},
            this.$scaleMode = t.StageScaleMode.SHOW_ALL,
            this.$orientation = t.OrientationMode.AUTO,
            this.$maxTouches = 99,
    ...
    var e = function(t) {
        ...
        e.create = function(t, e, i, n) {
            ...
            if (r || (r = t.eventPool = []), r.length) {
                ...
                s.$bubbles = !!i,
                s.$cancelable = !!n,
                s.$isDefaultPrevented = !1,
                s.$isPropagationStopped = !1,
                s.$isPropagationImmediateStopped = !1,
                s.$eventPhase = 2,
                s
            }
            return new t(e, i, n)
...
function(t) {
    var e = function(t) {
        ...
        var i = e;
        i.prototype;
        return e.FOCUS_IN = "focusIn",
        e.FOCUS_OUT = "focusOut",
        e
    } (t.Event);
    t.FocusEvent = e,
    t.registerClass(e, "egret.FocusEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(t) {
        ...
        var i = e;
        i.prototype;
        return e.PERMISSION_DENIED = "permissionDenied",
        e.UNAVAILABLE = "unavailable",
        e
    } (t.Event);
    t.GeolocationEvent = e,
    t.registerClass(e, "egret.GeolocationEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
    ...
    t.HTTPStatusEvent = e,
    t.registerClass(e, "egret.HTTPStatusEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
    ...
    t.IOErrorEvent = e,
    t.registerClass(e, "egret.IOErrorEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(t) {
    ...
    t.MotionEvent = e,
    t.registerClass(e, "egret.MotionEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(t) {
    ...
    t.registerClass(e, "egret.OrientationEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
    ...
    t.ProgressEvent = e,
    t.registerClass(e, "egret.ProgressEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
    ...
    t.registerClass(e, "egret.StageOrientationEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
    ...
    t.TextEvent = e,
    t.registerClass(e, "egret.TextEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
    ...
    t.TimerEvent = e,
    t.registerClass(e, "egret.TimerEvent")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = [],
...
function(t) {
    ...
    t.TouchEvent = i,
    t.registerClass(i, "egret.TouchEvent")
} (egret || (egret = {}));
var egret; !
...
function(t) {
    ...
    t.Filter = e,
    t.registerClass(e, "egret.Filter")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(t) {
    ...
    t.BlurFilter = e,
    t.registerClass(e, "egret.BlurFilter")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(t) {
    ...
    t.registerClass(e, "egret.ColorMatrixFilter")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(t) {
    ...
    t.GlowFilter = e,
    t.registerClass(e, "egret.GlowFilter")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(t) {
    ...
    t.registerClass(e, "egret.DropShadowFilter")
} (egret || (egret = {}));
var egret; !
function(t) {
    function e(t) {
    ...
    l = function(r) {
        ...
        c.concat = function(t) {
            ...
            r = this.d * t.d,
            s = this.tx * t.a + t.tx,
            a = this.ty * t.d + t.ty; (0 !== this.b || 0 !== this.c || 0 !== t.b || 0 !== t.c) && (e += this.b * t.c, r += this.c * t.b, i += this.a * t.b + this.b * t.d, n += this.c * t.a + this.d * t.c, s += this.ty * t.c, a += this.tx * t.b),
            this.a = e,
            this.b = i,
            this.c = n,
            this.d = r,
        ...
        c.$invertInto = function(t) {
            ...
            s = this.tx,
            a = this.ty;
            if (0 == i && 0 == n) return t.b = t.c = 0,
            void(0 == e || 0 == r ? t.a = t.d = t.tx = t.ty = 0 : (e = t.a = 1 / e, r = t.d = 1 / r, t.tx = -e * s, t.ty = -r * a));
            var o = e * r - i * n;
        ...
        c.prepend = function(t, e, i, n, r, s) {
            ...
            return this.tx = a * t + this.ty * i + r,
            this.ty = a * e + this.ty * n + s,
            this
        },
        c.append = function(t, e, i, n, r, s) {
            ...
            h = this.c,
            l = this.d;
            return (1 != t || 0 != e || 0 != i || 1 != n) && (this.a = t * a + e * h, this.b = t * o + e * l, this.c = i * a + n * h, this.d = i * o + n * l),
            this.tx = r * a + s * h + this.tx,
            this.ty = r * o + s * l + this.ty,
            this
        },
        ...
        c.createGradientBox = function(t, e, i, n, r) {
            ...
            void 0 === n && (n = 0),
            void 0 === r && (r = 0),
            this.createBox(t / 1638.4, e / 1638.4, i, n + t / 2, r + e / 2)
        },
        c.$transformBounds = function(t) {
            ...
            u > f && (x = u, u = f, f = x),
            p > v && (x = p, p = v, v = x),
            t.x = Math.floor(p > u ? u: p),
            t.width = Math.ceil((f > v ? f: v) - t.x),
            d > g && (x = d, d = g, g = x),
            $ > y && (x = $, $ = y, y = x),
            t.y = Math.floor($ > d ? d: $),
            t.height = Math.ceil((g > y ? g: y) - t.y)
        },
        ...
        c.$updateScaleAndRotation = function(t, n, r, s) {
            if (! (0 != r && r != a || 0 != s && s != a)) return this.a = t,
            this.b = this.c = 0,
            void(this.d = n);
            var o = e(r),
            h = i(r);
            r == s ? (this.a = o * t, this.b = h * t) : (this.a = e(s) * t, this.b = i(s) * t),
            this.c = -h * n,
            this.d = o * n
        },
        c.$preMultiplyInto = function(t, e) {
            ...
            o = t.ty * this.d + this.ty; (0 !== t.b || 0 !== t.c || 0 !== this.b || 0 !== this.c) && (i += t.b * this.c, s += t.c * this.b, n += t.a * this.b + t.b * this.d, r += t.c * this.a + t.d * this.c, a += t.ty * this.c, o += t.tx * this.b),
            e.a = i,
            e.b = n,
            e.c = r,
            e.d = s,
    ...
    t.Matrix = l,
    t.registerClass(l, "egret.Matrix"),
    t.$TempMatrix = new l
} (egret || (egret = {}));
var egret; !
function(t) {
    ...
    i = function(i) {
        ...
        a.$intersectInPlace = function(t) {
            ...
            if (a >= s) {
                ...
                if (h >= o) return this.setTo(s, o, a - s, h - o),
                this
            }
        ...
        a.union = function(t) {
            ...
            n = Math.min(e.y, t.y);
            return e.setTo(i, n, Math.max(e.right, t.right) - i, Math.max(e.bottom, t.bottom) - n),
            e
        },
    ...
    t.Rectangle = i,
    t.registerClass(i, "egret.Rectangle"),
...
function(t) {
    ...
    e[1039] = "crossOrigin images can not set pixelHitTest  property!",
    e[1040] = "hitTestPoint can not detect crossOrigin images! Please check if the display object has crossOrigin elements.",
    e[1041] = "egret.MainContext.runtimeType is deprecated, please use egret.Capabilities.runtimeType replace",
...
function(t) {
    ...
    e[1037] = "非正确的blob加载！",
    e[1038] = "XML 格式错误!",
    e[1039] = "跨域图片不能设置 pixelHitTest 属性!",
    e[1040] = "hitTestPoint 不能对跨域图片进行检测! 请检查该显示对象内是否含有跨域元素",
    e[1041] = "egret.MainContext.runtimeType 已废弃,请使用egret.Capabilities.runtimeType 代替",
...
function(t) {
    ...
    t.PromiseObject = e,
    t.registerClass(e, "egret.PromiseObject")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.HttpMethod = e,
    t.registerClass(e, "egret.HttpMethod")
} (egret || (egret = {}));
var egret; !
function(t) {} (egret || (egret = {}));
var egret; !
function(t) {
    ...
    t.registerClass(e, "egret.HttpResponseType")
} (egret || (egret = {}));
var egret; !
function(t) {} (egret || (egret = {}));
var egret; !
    ...
    function(e) {
        ...
        var n = function() {
            ...
            s.addRegion = function(i) {
                ...
                h = e.Region.create();
                return o.push(h.setTo(n, r, s, a)),
                this.$dirtyRegionPolicy != t.DirtyRegionPolicy.OFF && this.mergeDirtyList(o),
                !0
            },
            s.clear = function() {
                for (var t = this.dirtyList,
                i = t.length,
                n = 0; i > n; n++) e.Region.release(t[n]);
                t.length = 0
            },
            ...
            s.mergeDirtyList = function(t) {
                var n = t.length;
                if (2 > n) return ! 1;
                for (var r = this.hasClipRect,
                s = n > 3 ? Number.POSITIVE_INFINITY: 0, a = 0, o = 0, h = 0, l = 0; n - 1 > l; l++) {
                    var c = t[l];
                    r && (h += c.area);
                    for (var u = l + 1; n > u; u++) {
                        var d = t[u],
        ...
        e.DirtyRegion = n,
        t.registerClass(n, "egret.sys.DirtyRegion")
    } (e = t.sys || (t.sys = {}))
} (egret || (egret = {}));
var egret; !
function(t) {
    ...
    t.DirtyRegionPolicy = e,
    t.registerClass(e, "egret.DirtyRegionPolicy")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e; !
    function(e) {
        ...
        s = function(s) {
            function a(i) {
                ...
                this.rootMatrix = new t.Matrix,
                this.dirtyNodes = {},
                this.dirtyNodeList = [],
                this.dirtyList = null,
                this.dirtyRegion = new e.DirtyRegion,
                this.sizeChanged = !1,
                this.root = i,
            ...
            return a.release = function(n) {
                e.surfaceFactory.release(n.surface),
                t.Matrix.release(n.$renderMatrix),
                t.Matrix.release(n.$ratioMatrix),
                n.surface = null,
                n.renderContext = null,
                n.root = null,
                n.$renderMatrix = null,
                n.$ratioMatrix = null,
                n.needRedraw = !1,
            ...
            h.$update = function() {
                ...
                if (null == t) return ! 1;
                t.$removeFlagsUp(768),
                this.$renderAlpha = t.$getConcatenatedAlpha();
                var e = t.$getConcatenatedMatrix(),
                i = t.$getOriginalBounds(),
                n = t.$parentDisplayList,
                r = 1;
                n ? r = n.$pixelRatio: t.stage && t.stage.$displayList && (r = t.stage.$displayList.$pixelRatio),
                this.setDevicePixelRatio(r);
                var s = this.$renderRegion;
                if (this.needUpdateRegions && this.updateDirtyRegions(), !n) return s.setTo(0, 0, 0, 0),
                s.moved = !1,
                !1;
                ...
                a.copyFrom(e);
                var o = n.root;
                return o !== t.$stage && t.$getConcatenatedMatrixAt(o, a),
                this.$ratioMatrix.$preMultiplyInto(a, a),
                s.updateRegion(i, a),
                !0
            },
            h.$render = function(t) {
            ...
            h.updateDirtyRegions = function() {
                ...
                return this.dirtyList = e.getDirtyRegions(),
                this.dirtyList
            },
            h.drawToSurface = function() {
                ...
                if (e && e.length > 0) {
                    ...
                    n.save(),
                    n.beginPath(),
                    i && n.setTransform(1, 0, 0, 1, -this.offsetX * this.$pixelRatio, -this.offsetY * this.$pixelRatio);
                    for (var r = e.length,
                    s = 0; r > s; s++) {
                        var a = e[s];
                        n.clearRect(a.minX, a.minY, a.width, a.height),
                        n.rect(a.minX, a.minY, a.width, a.height)
                    }
                    n.clip(),
                    i && n.setTransform(i.a, i.b, i.c, i.d, i.tx, i.ty),
                    t = this.drawDisplayObject(this.root, n, e, i, null, null),
                    n.restore()
                }
            ...
            h.drawDisplayObject = function(t, e, i, n, r, s) {
                ...
                if (r ? (r.needRedraw && (h += r.drawToSurface()), a = r, o = 1) : t.$renderRegion && (a = t, o = t.$renderAlpha), a) {
                    ...
                    else if (!a.$isDirty) for (var c = i.length,
                    u = 0; c > u; u++) if (l.intersects(i[u])) {
                        a.$isDirty = !0;
                        break
                    }
                    if (a.$isDirty) {
                        ...
                        n ? (e.transform(d.a, d.b, d.c, d.d, d.tx, d.ty), a.$render(e), e.setTransform(n.a, n.b, n.c, n.d, n.tx * this.$pixelRatio, n.ty * this.$pixelRatio)) : (e.setTransform(d.a, d.b, d.c, d.d, d.tx, d.ty), a.$render(e)),
                        a.$isDirty = !1
                    }
                }
                if (r) return h;
                var f = t.$children;
                if (f) for (var g = f.length,
                p = 0; g > p; p++) {
                    var $ = f[p]; ! $.$visible || $.$alpha <= 0 || $.$maskedObject ? $.$isDirty = !1 : 0 !== $.$blendMode || $.$mask && $.$mask.$parentDisplayList ? h += this.drawWithClip($, e, i, n, s) : $.$scrollRect || $.$maskRect ? h += this.drawWithScrollRect($, e, i, n, s) : $.isFPS ? this.drawDisplayObject($, e, i, n, $.$displayList, s) : h += this.drawDisplayObject($, e, i, n, $.$displayList, s)
                }
                return h
            },
            h.drawWithClip = function(i, s, a, o, h) {
                ...
                if (v !== i.$stage && ($ = v.$getInvertedConcatenatedMatrix(), $.$preMultiplyInto(p, p)), this.$ratioMatrix.$preMultiplyInto(p, p), f) {
                    ...
                    x.copyFrom(f.$getConcatenatedMatrix()),
                    $ && $.$preMultiplyInto(x, x),
                    this.$ratioMatrix.$preMultiplyInto(x, x),
                    g.updateRegion(y, x),
                    t.Matrix.release(x)
                }
                var m;
                if (d && (m = e.Region.create(), m.updateRegion(d, p)), m && g ? (m.intersect(g), e.Region.release(g)) : !m && g && (m = g), m) {
                    if (m.isEmpty() || h && !h.intersects(m)) return e.Region.release(m),
                    t.Matrix.release(p),
                    l
                } else m = e.Region.create(),
                y = i.$getOriginalBounds(),
                m.updateRegion(y, p);
                for (var T = !1,
                _ = a.length,
                b = 0; _ > b; b++) if (m.intersects(a[b])) {
                    T = !0;
                    break
                }
                if (!T) return e.Region.release(m),
                t.Matrix.release(p),
                l;
                var C = this.createRenderContext(m.width, m.height);
                if (!C) return l += this.drawDisplayObject(i, s, a, o, i.$displayList, h),
                e.Region.release(m),
                t.Matrix.release(p),
                l;
                if (d) {
                    var x = p;
                    C.setTransform(x.a, x.b, x.c, x.d, x.tx - m.minX, x.ty - m.minY),
                    C.beginPath(),
                    C.rect(d.x, d.y, d.width, d.height),
                    C.clip()
                }
                ...
                if (l += this.drawDisplayObject(i, C, a, F, i.$displayList, m), t.Matrix.release(F), f) {
                    ...
                    if (!E) return l += this.drawDisplayObject(i, s, a, o, i.$displayList, h),
                    e.surfaceFactory.release(C.surface),
                    e.Region.release(m),
                    t.Matrix.release(p),
                    l;
                    E.setTransform(1, 0, 0, 1, -m.minX, -m.minY),
                    F = t.Matrix.create().setTo(1, 0, 0, 1, -m.minX, -m.minY);
                    var R = this.drawDisplayObject(f, E, a, F, f.$displayList, m);
                    t.Matrix.release(F),
                    R > 0 && (l += R, C.globalCompositeOperation = "destination-in", C.setTransform(1, 0, 0, 1, 0, 0), C.globalAlpha = 1, C.drawImage(E.surface, 0, 0)),
                    e.surfaceFactory.release(E.surface)
                }
                return l > 0 && (l++, c && (s.globalCompositeOperation = u), s.globalAlpha = 1, o ? (s.translate(m.minX, m.minY), s.drawImage(C.surface, 0, 0), s.setTransform(o.a, o.b, o.c, o.d, o.tx * this.$pixelRatio, o.ty * this.$pixelRatio)) : (s.setTransform(1, 0, 0, 1, m.minX, m.minY), s.drawImage(C.surface, 0, 0)), c && (s.globalCompositeOperation = r)),
                e.surfaceFactory.release(C.surface),
                e.Region.release(m),
                t.Matrix.release(p),
                l
            ...
            h.drawWithScrollRect = function(i, n, r, s, a) {
                ...
                c !== i.$stage && c.$getInvertedConcatenatedMatrix().$preMultiplyInto(l, l),
                this.$ratioMatrix.$preMultiplyInto(l, l);
                var u = e.Region.create();
                if (h.isEmpty() || u.updateRegion(h, l), u.isEmpty() || a && !a.intersects(u)) return e.Region.release(u),
                t.Matrix.release(l),
                o;
                for (var d = !1,
                f = r.length,
                g = 0; f > g; g++) if (u.intersects(r[g])) {
                    d = !0;
                    break
                }
            ...
            h.changeSurfaceSize = function() {
                ...
                if (this.sizeChanged) {
                    ...
                    c = l.surface;
                    e.sharedRenderContext = o,
                    this.renderContext = l,
                    this.surface = c,
                    c.width = Math.max(r.width * s, 257),
                    c.height = Math.max(r.height * a, 257),
                    l.setTransform(1, 0, 0, 1, 0, 0),
                    l.drawImage(h, (i - this.offsetX) * s, (n - this.offsetY) * a),
                    t.Capabilities.runtimeType != t.RuntimeType.NATIVE && (h.height = 1, h.width = 1)
                } else this.sizeChanged = !0,
                h.width = Math.max(r.width * s, 257),
                h.height = Math.max(r.height * a, 257);
                this.rootMatrix.setTo(1, 0, 0, 1, -this.offsetX, -this.offsetY),
                this.renderContext.setTransform(1, 0, 0, 1, -r.x, -r.y)
            },
            h.setDevicePixelRatio = function(e) {
                void 0 === e && (e = 1),
                this.$pixelRatio == e && this.$ratioMatrix || (this.$ratioMatrix || (this.$ratioMatrix = t.Matrix.create()), this.$ratioChanged = !0, this.$pixelRatio = e, this.$ratioMatrix.setTo(e, 0, 0, e, 0, 0), this.root.$invalidate(!0))
            },
        ...
        e.DisplayList = s,
        t.registerClass(s, "egret.sys.DisplayList", ["egret.sys.Renderable"])
    } (e = t.sys || (t.sys = {}))
} (egret || (egret = {}));
var egret; !
function(t) {} (egret || (egret = {}));
...
function(t) {
    var e = function() {
        ...
        t.LANDSCAPE_FLIPPED = "landscapeFlipped",
        t
    } ();
    t.OrientationMode = e,
    t.registerClass(e, "egret.OrientationMode")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e; !
    function(e) {
        function i(i, n, r, s) {
            if (n && (t.log = function() {
                ...
                i = "",
                n = 0; t > n; n++) i += arguments[n] + " ";
                e.$logToFPS(i),
                console.log.apply(console, a(arguments))
            }), l = s ? {}: s, n = !!n, this.showFPS = !!i, this.showLog = n, !this.fpsDisplay) {
                var o = void 0 === s.x ? 0 : s.x,
                u = void 0 === s.y ? 0 : s.y;
                h = this.fpsDisplay = new FPS(this.stage, i, n, r, s),
                h.x = o,
                h.y = u;
                for (var d = c.length,
                f = 0; d > f; f++) h.updateInfo(c[f]);
                c = null
            }
        }
        function n(t) {
            t = !!t,
            this._showPaintRect != t && (this._showPaintRect = t, t ? (this.stageDisplayList || (this.stageDisplayList = e.DisplayList.create(this.stage)), this.stage.$displayList = this.stageDisplayList) : this.stage.$displayList = this.screenDisplayList)
        }
        function r(t) {
            for (var e = t.length,
            i = [], n = 0; e > n; n++) {
                var r = t[n];
                i[n] = [r.minX, r.minY, r.width, r.height],
                r.width -= 1,
                r.height -= 1
            }
            ...
            n = 0; e > n; n++) {
                var r = t[n];
                a.clearRect(r.minX, r.minY, r.width, r.height),
                a.rect(r.minX, r.minY, r.width, r.height)
            }
            a.clip(),
            a.drawImage(this.stageDisplayList.surface, 0, 0),
            a.restore()
        }
        function s(t, e, i, n, r) {
            r.strokeStyle = "rgb(255,0,0)",
            r.lineWidth = 5,
            r.strokeRect(t - .5, e - .5, i, n)
        }
        function a(t) {
        ...
        var o = function(a) {
            function o(t, e, o) {
                a.call(this),
                this.isPlaying = !1,
                this.entryClassName = o,
                this.stage = e,
                this.screenDisplayList = this.createDisplayList(e, t),
                this.showFPS = !1,
                this.showLog = !1,
                this._showPaintRect = !1,
                this.stageDisplayList = null,
                this.paintList = [],
                this.displayFPS = i,
                this.showPaintRect = n,
                this.drawPaintRect = r,
                this.drawDirtyRect = s
            }
            __extends(o, a);
            var h = o,
            l = h.prototype;
            return l.createDisplayList = function(t, i) {
                ...
                return n.renderContext = i,
                t.$displayList = n,
                n.setClipRect(t.$stageWidth, t.$stageHeight),
                n
            },
            l.start = function() { ! this.isPlaying && this.stage && (e.$TempStage = e.$TempStage || this.stage, this.isPlaying = !0, this.root || this.initialize(), e.$ticker.$addPlayer(this))
            },
            ...
            l.$render = function(e, i) { (this.showFPS || this.showLog) && this.stage.addChild(this.fpsDisplay),
                this.callLaters(),
            ...
            l.updateStageSize = function(e, i, n) {
                void 0 === n && (n = 1);
                var r = this.stage; (e !== r.$stageWidth || i !== r.$stageHeight || this.screenDisplayList.$pixelRatio !== n) && (r.$stageWidth = e, r.$stageHeight = i, this.screenDisplayList.setDevicePixelRatio(n), this.screenDisplayList.setClipRect(e, i), this.stageDisplayList && (this.stageDisplayList.setDevicePixelRatio(n), this.stageDisplayList.setClipRect(e, i)), r.dispatchEventWith(t.Event.RESIZE), r.$invalidate(!0))
            },
            o
        } (t.HashObject);
        e.Player = o,
        t.registerClass(o, "egret.sys.Player");
        var h, l, c = [];
        ...
        FPS = function(e) {
            ...
            i.prototype.createDisplay = function() {
                this.shape = new t.Shape,
                this.addChild(this.shape);
                var e = new t.TextField;
                e.size = void 0 === this.styles.size ? 24 : parseInt(this.styles.size),
                this.addChild(e),
                this.textField = e,
                e.textColor = void 0 === this.styles.textColor ? 49664 : parseInt(this.styles.textColor),
                ...
                e.fontFamily = "monospace",
                e.x = 10,
                e.size = void 0 === this.styles.size ? 12 : this.styles.size / 2,
                e.y = 10
            },
            i.prototype.update = function(e, i, n, r, s) {
                ...
                if (this.totalTime += a - this.lastTime, this.lastTime = a, this.totalTick++, this.drawCalls += e, this.dirtyRatio += i, this.costDirty += n, this.costRender += r, this.costTicker += s, this.totalTime > 500) {
                    ...
                    f = "FPS: " + o + "\nDraw: " + h + "," + l + "%\nCost: " + d + "," + c + "," + u;
                    this.textField.text != f && (this.textField.text = f, this.updateLayout()),
                    this.totalTick = 0,
            ...
            i.prototype.updateInfo = function(t) {
                if (this.showLog && this.filter(t)) {
                    ...
                    if (t && e.push(t), this.infoText.width = 0 / 0, this.infoText.text = e.join("\n"), this._stage.stageHeight > 0) for (this.infoText.textWidth > this._stage.stageWidth - 20 && (this.infoText.width = this._stage.stageWidth - 20); this.infoText.textHeight > this._stage.stageHeight - 20;) e.shift(),
                    this.infoText.text = e.join("\n");
                    this.updateLayout()
                }
            },
            i.prototype.updateLayout = function() {
                if (this.showFPS && (this.infoText.y = this.textField.height + 20), t.Capabilities.runtimeType != t.RuntimeType.NATIVE) {
                    ...
                    e.clear(),
                    e.fillStyle = "rgba(68,68,68," + (this.styles.bgAlpha || .9) + ")",
                    e.fillRect(0, 0, Math.max(160, this.width + 20), this.height + 20)
                }
            },
            i
        } (t.Sprite),
    ...
    function(e) {
        ...
        n = function() {
            ...
            n.intersect = function(t) {
                ...
                this.maxX > t.maxX && (this.maxX = t.maxX),
                this.minX >= this.maxX ? void this.setEmpty() : (this.minY < t.minY && (this.minY = t.minY), this.maxY > t.maxY && (this.maxY = t.maxY), this.minY >= this.maxY ? void this.setEmpty() : void this.updateArea())
            },
            n.setEmpty = function() {
                this.minX = 0,
                this.minY = 0,
            ...
            n.updateRegion = function(t, e) {
                ...
                p = f + t.width,
                $ = g + t.height;
                if (1 == o && 0 == h && 0 == l && 1 == c) i = Math.floor(f + u) - 1,
                n = Math.floor(g + d) - 1,
                r = Math.ceil(p + u) + 1,
                s = Math.ceil($ + d) + 1;
                else {
                    ...
                    v > x && (F = v, v = x, x = F),
                    T > b && (F = T, T = b, b = F),
                    i = Math.floor(T > v ? v: T) - 1,
                    r = Math.ceil(x > b ? x: b) + 1,
                    y > m && (F = y, y = m, m = F),
                    _ > C && (F = _, _ = C, C = F),
                    n = Math.floor(_ > y ? y: _) - 1,
                    s = Math.ceil(m > C ? m: C) + 1
                }
                this.minX = i,
                this.minY = n,
                this.maxX = r,
        ...
        e.Region = n,
        t.registerClass(n, "egret.sys.Region")
    } (e = t.sys || (t.sys = {}))
} (egret || (egret = {}));
var egret; !
function(t) {
    ...
    function(e) {
        ...
        e.ScreenAdapter = i,
        t.registerClass(i, "egret.sys.ScreenAdapter", ["egret.sys.IScreenAdapter"])
    } (e = t.sys || (t.sys = {}))
} (egret || (egret = {}));
var egret; !
function(t) {
    ...
    t.StageScaleMode = e,
    t.registerClass(e, "egret.StageScaleMode")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e; !
...
function(t) {
    ...
    function(e) {
        ...
        var i = function() {
            ...
            var n = i,
            r = n.prototype;
            return r.$addPlayer = function(t) { - 1 == this.playerList.indexOf(t) && (this.playerList = this.playerList.concat(), this.playerList.push(t))
            },
            ...
            r.getTickIndex = function(t, e) {
                ...
                r = i.length - 1; r >= 0; r--) if (i[r] == t && n[r] == e) return r;
                return - 1
            },
            ...
            r.$setFrameRate = function(e) {
                return e = +e || 0,
                0 >= e ? !1 : this.$frameRate == e ? !1 : (this.$frameRate = e, e > 60 && (e = 60), t.Capabilities.runtimeType == t.RuntimeType.NATIVE && (egret_native.setFrameRate(e), e = 60), this.lastCount = this.frameInterval = Math.round(6e4 / e), !0)
            },
            r.update = function() {
        ...
        e.SystemTicker = i,
        t.registerClass(i, "egret.sys.SystemTicker"),
...
function(t) {
    ...
    function(e) {
        var i = function(e) {
            ...
            r.onTouchBegin = function(e, i, n) {
                if (! (this.useTouchesCount >= this.maxTouches)) {
                    ...
                    null == this.touchDownTarget[n] && (this.touchDownTarget[n] = r, this.useTouchesCount++),
                    t.TouchEvent.dispatchTouchEvent(r, t.TouchEvent.TOUCH_BEGIN, !0, !0, e, i, n, !0)
                }
            },
            ...
            r.onTouchEnd = function(e, i, n) {
                if (null != this.touchDownTarget[n]) {
                    ...
                    delete this.touchDownTarget[n],
                    this.useTouchesCount--,
                    t.TouchEvent.dispatchTouchEvent(r, t.TouchEvent.TOUCH_END, !0, !0, e, i, n, !1),
                    s == r ? t.TouchEvent.dispatchTouchEvent(r, t.TouchEvent.TOUCH_TAP, !0, !0, e, i, n, !1) : t.TouchEvent.dispatchTouchEvent(s, t.TouchEvent.TOUCH_RELEASE_OUTSIDE, !0, !0, e, i, n, !1)
                }
            },
        ...
        e.TouchHandler = i,
        t.registerClass(i, "egret.sys.TouchHandler")
    } (e = t.sys || (t.sys = {}))
} (egret || (egret = {}));
var egret; !
function(t) {
...
function(t) {
    ...
    t.RuntimeType = e,
    t.registerClass(e, "egret.RuntimeType");
    var i = function() {
        function t() {}
        var e = __define,
        i = t;
    ...
    t.Capabilities = i,
    t.registerClass(i, "egret.Capabilities")
} (egret || (egret = {}));
...
function(t) {
    var e = function(t) {
        function e(e, i) {
            ...
            "string" == typeof i ? this.charList = this.parseConfig(i) : i && i.hasOwnProperty("frames") ? this.charList = i.frames: this.charList = {}
        }
        __extends(e, t);
        var i = e,
        n = i.prototype;
        ...
        n.parseConfig = function(t) {
            t = t.split("\r\n").join("\n");
            for (var e = t.split("\n"), i = this.getConfigByKey(e[3], "count"), n = {},
            r = 4; 4 + i > r; r++) {
                var s = e[r],
                a = String.fromCharCode(this.getConfigByKey(s, "id")),
                o = {};
                n[a] = o,
                o.x = this.getConfigByKey(s, "x"),
                o.y = this.getConfigByKey(s, "y"),
                o.w = this.getConfigByKey(s, "width"),
                o.h = this.getConfigByKey(s, "height"),
                o.offX = this.getConfigByKey(s, "xoffset"),
                o.offY = this.getConfigByKey(s, "yoffset")
            }
            return n
        },
    ...
    t.BitmapFont = e,
    t.registerClass(e, "egret.BitmapFont")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
        ...
        s.$render = function(e) {
            ...
            s = n.$getTextLines(),
            a = s.length;
            if (0 != a) for (var o = n.$textLinesWidth,
            h = r[5], l = h._getFirstCharHeight(), c = Math.ceil(l * i.EMPTY_FACTOR), u = !isNaN(r[1]), d = r[8], f = r[0], g = r[1], p = r[10], $ = n.$textOffsetY + n.$textStartY, v = n.$lineHeights, y = 0; a > y; y++) {
                var x = v[y];
                if (u && y > 0 && $ + x > g) break;
                var m = s[y],
                T = m.length,
                ...
                for (var C = 0; T > C; C++) {
                    ...
                    if (E) {
                        ...
                        S = E._bitmapHeight;
                        e.drawImage(E._bitmapData, E._bitmapX, E._bitmapY, R, S, _ + E._offsetX, $ + E._offsetY, E.$getScaleBitmapWidth(), E.$getScaleBitmapHeight()),
                        _ += E.$getTextureWidth() + r[4]
        ...
        s.$getTextLines = function() {
            ...
            for (var h = r[3], l = r[4], c = 0, u = 0, d = 0, f = 0, g = !isNaN(r[0]), p = r[0], $ = r[1], v = r[5], y = v._getFirstCharHeight(), x = Math.ceil(y * i.EMPTY_FACTOR), m = r[2], T = m.split(/(?:\r\n|\r|\n)/), _ = T.length, b = !0, C = 0; _ > C; C++) {
                for (var F = T[C], E = F.length, R = 0, S = 0, w = !0, L = !1, O = 0; E > O; O++) {
                    ...
                    if (w && (w = !1, d = Math.min(A, d)), b && (b = !1, f = Math.min(B, f)), g && O > 0 && S + M > p) {
            ...
            n.$textStartY = 0;
            var P;
            return p > c && (P = r[10], P == t.HorizontalAlign.RIGHT ? n.$textStartX = p - c: P == t.HorizontalAlign.CENTER && (n.$textStartX = Math.floor((p - c) / 2))),
            $ > u && (P = r[11], P == t.VerticalAlign.BOTTOM ? n.$textStartY = $ - u: P == t.VerticalAlign.MIDDLE && (n.$textStartY = Math.floor(($ - u) / 2))),
            s
        },
        i.EMPTY_FACTOR = .33,
        i
    ...
    t.BitmapText = e,
    t.registerClass(e, "egret.BitmapText")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.HorizontalAlign = e,
    t.registerClass(e, "egret.HorizontalAlign")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
        ...
        n.parser = function(e) {
            ...
            n = e.length; n > i;) {
                var r = e.indexOf("<", i);
                if (0 > r) this.addToResultArr(e.substring(i)),
                i = n;
                else {
                    this.addToResultArr(e.substring(i, r));
                    var s = e.indexOf(">", r); - 1 == s ? (t.$error(1038), s = r) : "/" == e.charAt(r + 1) ? this.stackArray.pop() : this.addToArray(e.substring(r + 1, s)),
                    i = s + 1
                }
            }
        ...
        n.changeStringToObject = function(t) {
            ...
            if ("i" == t.charAt(0) || "b" == t.charAt(0) || "u" == t.charAt(0)) this.addProperty(e, t, "true");
                ...
                for (var n, r = 0; n = t.match(this.getHeadReg());) {
                    ...
                    r = a.length;
                    this.addProperty(e, s.substring(0, s.length - 1).trim(), a.trim()),
    ...
    t.HtmlTextParser = e,
    t.registerClass(e, "egret.HtmlTextParser")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function(e) {
        ...
        r.updateTextHandler = function(e) {
            ...
            null != i[36] && (s = new RegExp("[^" + i[36] + "]", "g"), a = n.match(s), n = a ? a.join("") : "", r = !0),
            r && this.stageText.$getText() != n && this.stageText.$setText(n),
            this.resetText(),
        ...
        r.updateInput = function() { ! this._text.$visible && this.stageText && this._hideInput()
        },
        r._updateProperties = function() {
            if (this._isFocus) return this.stageText.$resetStageText(),
            void this.updateInput();
            var t = this._text.$stage;
            if (null == t);
            else for (var e = this._text,
            i = e.$visible;;) {
                if (!i) break;
    ...
    t.InputController = e,
    t.registerClass(e, "egret.InputController")
} (egret || (egret = {}));
var egret; !
function(t) {} (egret || (egret = {}));
var egret; !
function(t) {
    function e(e, n, r, s, a, o, h) {
        ...
        var u;
        u = null != h.stroke ? h.stroke: n.$TextField[27],
        e.fillStyle = l,
        e.strokeStyle = c,
        u && (e.lineWidth = 2 * u, e.strokeText(r, s, a, o || 65535)),
        e.fillText(r, s, a, o || 65535)
    }
    function i(t, e, i) {
        void 0 === i && (i = null),
        i = i || {};
    ...
    r = function(r) {
        ...
        h.getFontString = function() {
            var e = this.$TextField;
            return e[17] && (e[17] = !1, e[12] = t.sys.toFontString(this)),
            e[12]
        },
        a(h, "textAlign",
        function() {
        ...
        h.$setBaseText = function(t) {
            if (null == t && (t = ""), t = t.toString(), this.isFlow = !1, this.$TextField[13] != t) {
                ...
                this.$TextField[13] = t;
                var e = "";
                return e = this.$TextField[20] ? this.changeToPassText(t) : t,
                this.setMiddleStyle([{
                    text: e
                }]),
                !0
        ...
        h.$setDisplayAsPassword = function(t) {
            if (this.$TextField[20] != t) {
                ...
                this.$invalidateTextField();
                var e = "";
                return e = t ? this.changeToPassText(this.$TextField[13]) : this.$TextField[13],
                this.setMiddleStyle([{
                    text: e
                }]),
                !0
        ...
        a(h, "selectionBeginIndex",
        function() {
            return 0
        }),
        a(h, "selectionEndIndex",
        function() {
            return 0
        }),
        a(h, "caretIndex",
        ...
        h.$setWidth = function(t) {
            ...
            return t = +t,
            0 > t ? !1 : (this.$invalidateTextField(), !0)
        },
        ...
        h.fillBackground = function() {
            ...
            i = e.bgGraphics;
            i && i.clear(),
            (this.$TextField[33] || this.$TextField[31]) && (null == i && (i = e.bgGraphics = new t.Graphics, this.bgGraphics.$renderContext.$targetDisplay = this), this.$TextField[33] && i.beginFill(this.$TextField[34], 1), this.$TextField[31] && i.lineStyle(1, this.$TextField[32]), i.drawRect(0, 0, e.$getWidth(), e.$getHeight()), i.endFill())
        },
        h.setFocus = function() {
            t.$warn(1013)
        },
        ...
        h.$update = function(e) {
            ...
            n.copyFrom(e),
            i.$TextField[31] && (n.width += 2, n.height += 2);
            var s = 2 * i.$TextField[27];
            s > 0 && (n.width += 2 * s, n.height += 2 * s),
            n.x -= s + 2,
            n.y -= s + 2,
            n.width = Math.ceil(n.width) + 4,
            n.height = Math.ceil(n.height) + 4;
        ...
        h.changeToPassText = function(t) {
            if (this.$TextField[20]) {
                for (var e = "",
                i = 0,
                n = t.length; n > i; i++) switch (t.charAt(i)) {
                case "\n":
                    e += "\n";
                    break;
                case "\r":
        ...
        h.$getLinesArr = function() {
            ...
            g = r.length; g > f; f++) {
                ...
                for (var $ = p.text.toString(), v = $.split(/(?:\r\n|\r|\n)/), y = 0, x = v.length; x > y; y++) {
                    ...
                    h[d] = o, l = 0, u = 0, c = 0),
                    u = this.$TextField[24] == t.TextFieldType.INPUT ? this.$TextField[0] : Math.max(u, p.style.size || this.$TextField[0]);
                    var m = !0;
                    if ("" == v[y]) y == x - 1 && (m = !1);
                    else {
                        ...
                        y == x - 1 && (m = !1);
                            ...
                            for (var E = F.length,
                            R = 0; E > _ && (T = s.measureText(F[_]).width, !(0 != l && l + T > a && l + _ != 0)); _++) R += F[_].length,
                            b += T,
                            l += T,
                            c += R;
                            if (_ > 0) {
                    ...
                    m && (c++, o.hasNextLine = !0),
                    y < v.length - 1 && (o.width = l, o.height = u, o.charNum = c, this.$TextField[5] = Math.max(this.$TextField[5], l), this.$TextField[6] += u, d++)
                }
                f == r.length - 1 && o && (o.width = l, o.height = u, o.charNum = c, this.$TextField[5] = Math.max(this.$TextField[5], l), this.$TextField[6] += u)
            }
            return this.$TextField[29] = h.length,
            this.fillBackground(),
            h
        },
        h.drawText = function(i) {
            ...
            if (0 != r[5]) {
                ...
                for (var d = t.TextFieldUtils.$getHalign(n), f = 0, g = l, p = r[29]; p > g; g++) {
                    ...
                    for (var y = 0,
                    x = $.elements.length; x > y; y++) {
                        var m = $.elements[y],
                        T = m.style.size || r[0];
                        e(i, n, m.text, f, h + (v - T) / 2, m.width, m.style),
                        m.style.underline && this.drawTempArray.push({
                            x: f,
                            y: h + v / 2,
                            w: m.width,
                            c: m.style.textColor
                ...
                if (this.drawTempArray.length > 0) {
                    ...
                    for (var _ = 0; _ < this.drawTempArray.length; _++) {
                        ...
                        b = null != C.c ? t.toColorString(C.c) : r[11],
                        i.beginPath(),
                        i.strokeStyle = b,
                        i.moveTo(C.x, C.y),
                        i.lineTo(C.x + C.w, C.y),
                        i.closePath(),
                        i.stroke()
                    }
                    i.restore(),
        ...
        s.default_fontFamily = "Arial",
        s
    } (t.DisplayObject);
    t.TextField = r,
    t.registerClass(r, "egret.TextField")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e; !
    function(t) {
        function e(t) {
            var e = "";
            return t.italic && (e += "italic "),
            t.bold && (e += "bold "),
            e += (t.fontSize || 12) + "px ",
            e += t.fontFamily || "sans-serif"
        }
        t.toFontString = e
    } (e = t.sys || (t.sys = {}))
} (egret || (egret = {}));
...
function(t) {
    ...
    t.TextFieldType = e,
    t.registerClass(e, "egret.TextFieldType")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
        ...
        return e.$getStartLine = function(t) {
            ...
            r = 0,
            s = i[4];
            return isNaN(s) || (s > n || n > s && (r = Math.max(i[28] - 1, 0), r = Math.min(i[29] - 1, r)), i[30] || (r = Math.max(i[28] - 1, 0), i[29] > 0 && (r = Math.min(i[29] - 1, r)))),
            r
        },
        e.$getHalign = function(e) {
            var i = e.$getLinesArr(),
            n = 0;
            return e.$TextField[9] == t.HorizontalAlign.CENTER ? n = .5 : e.$TextField[9] == t.HorizontalAlign.RIGHT && (n = 1),
            e.$TextField[24] == t.TextFieldType.INPUT && !e.$TextField[30] && i.length > 1 && (n = 0),
            n
        },
        ...
        e.$getValign = function(i) {
            ...
            if (!isNaN(r) && r > n) {
                var s = 0;
                return i.$TextField[10] == t.VerticalAlign.MIDDLE ? s = .5 : i.$TextField[10] == t.VerticalAlign.BOTTOM && (s = 1),
                s
            }
            return 0
        },
    ...
    t.TextFieldUtils = e,
    t.registerClass(e, "egret.TextFieldUtils")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.VerticalAlign = e,
    t.registerClass(e, "egret.VerticalAlign")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.Endian = e,
    t.registerClass(e, "egret.Endian");
    var i = function() {
        function i(t) {
        ...
        s.writeBytes = function(t, e, i) {
            ...
            if (! (0 > e) && !(0 > i) && (n = 0 == i ? t.length - e: Math.min(t.length - e, i), n > 0)) {
                ...
                for (var r = new DataView(t.buffer), i = n, s = 4; i > s; i -= s) this.data.setUint32(this._position, r.getUint32(e)),
                this.position += s,
                e += s;
        ...
        s.writeUTF = function(t) {
            ...
            r = n.length;
            this.validateBuffer(i.SIZE_OF_UINT16 + r),
            this.data.setUint16(this.position, r, this.endian == e.LITTLE_ENDIAN),
            this.position += i.SIZE_OF_UINT16,
            this._writeUint8Array(n, !1)
        },
        ...
        s.validateBuffer = function(t, e) {
            if (void 0 === e && (e = !1), this.write_position = t > this.write_position ? t: this.write_position, t += this._position, this.data.byteLength < t || e) {
                ...
                i.set(new Uint8Array(this.data.buffer, 0, n)),
                this.buffer = i.buffer
            }
        },
        s.encodeUTF8 = function(t) {
            for (var e = 0,
            i = this.stringToCodePoints(t), n = []; i.length > e;) {
                var r = i[e++];
        ...
        s.decodeUTF8 = function(t) {
            ...
            h = 0; t.length > n;) {
                ...
                if (l == this.EOF_byte) e = 0 != a ? this.decoderError(i) : this.EOF_code_point;
                    ...
                    o = 0,
                    h = 0,
                    e = this.inRange(c, u, 1114111) && !this.inRange(c, 55296, 57343) ? c: this.decoderError(i, l)
                } else s = 0,
                a = 0,
                o = 0,
                h = 0,
    ...
    t.ByteArray = i,
    t.registerClass(i, "egret.ByteArray")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
    ...
    t.Logger = e,
    t.registerClass(e, "egret.Logger")
} (egret || (egret = {}));
var egret; !
function(t) {
    var e = function() {
        ...
        t.sinInt = function(t) {
            return t %= 360,
            0 > t && (t += 360),
            90 > t ? egret_sin_map[t] : 180 > t ? egret_cos_map[t - 90] : 270 > t ? -egret_sin_map[t - 180] : -egret_cos_map[t - 270]
        },
        t.cos = function(e) {
            var i = Math.floor(e),
            n = i + 1,
        ...
        t.cosInt = function(t) {
            return t %= 360,
            0 > t && (t += 360),
            90 > t ? egret_cos_map[t] : 180 > t ? -egret_sin_map[t - 90] : 270 > t ? -egret_cos_map[t - 180] : egret_sin_map[t - 270]
        },
        t
    } ();
    t.NumberUtils = e,
    t.registerClass(e, "egret.NumberUtils")
} (egret || (egret = {}));
for (var egret_sin_map = {},
egret_cos_map = {},
DEG_TO_RAD = Math.PI / 180,
NumberUtils_i = 0; 90 >= NumberUtils_i; NumberUtils_i++) egret_sin_map[NumberUtils_i] = Math.sin(NumberUtils_i * DEG_TO_RAD),
...
function(t) {
    var e = function(e) {
        ...
        s.$update = function(e) {
            ...
            i && (this.stop(), t.TimerEvent.dispatchTimerEvent(this, t.TimerEvent.TIMER_COMPLETE)),
            !1
        },
        i
    } (t.EventDispatcher);
    t.Timer = e,
    t.registerClass(e, "egret.Timer")
} (egret || (egret = {}));
var egret; !
function(t) {} (egret || (egret = {}));
var egret; !
...
function(t) {
    function e(t, e, i) {
        ...
        if (null != h) {
            ...
            o = Object.getOwnPropertyDescriptor(h, i).set,
            s[i] = o,
            o.apply(e, n)
        }
    }
    function i(t, e, i) {
        ...
        if (null != a) {
            ...
            return s = Object.getOwnPropertyDescriptor(a, i).get,
            n[i] = s,
            s.call(e)
        }
    }
...
function(t) {
    function e(e) {
        return e.hashCode = e.$hashCode = t.$hashCount++,
        e
    }
    t.$toBitmapData = e
} (egret || (egret = {}));

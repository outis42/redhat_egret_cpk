...
(function (starlingswf) {
    ...
    var Swf = (function () {
        ...
        p.createMovie = function (name, data, cls) {
            if (data === void 0) { data = null; }
